...
def objective(trial):
    ...
    if optimizer_name == "Adam":
        ...
        optimizer = torch.optim.SGD(classifier_params, lr=lr, weight_decay=weight_decay, momentum=0.9)
    # Optimizer
    # if optimizer_name == "Adam":
        # optimizer = torch.optim.Adam(model.classifier.parameters(), lr=lr, weight_decay=weight_decay)
    # else:
        # optimizer = torch.optim.SGD(model.classifier.parameters(), lr=lr, weight_decay=weight_decay, momentum=0.9)
